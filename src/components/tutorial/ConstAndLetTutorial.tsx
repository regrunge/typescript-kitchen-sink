...
const ConstAndLetTutorial: React.FC<ConstAndLetTutorialProps> = (
  props: ConstAndLetTutorialProps,
) => {
    ...
    <View>
      ...
      {showDemo && (
        <>
          ...
          <Text>
            {personObject.name} is {personObject.age} years old and{' '}
            {translations.genders[personObject.gender]}
          </Text>
